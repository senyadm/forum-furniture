      ...
      <div className="relative mx-auto max-w-[1200px] px-6">
        ...
        <div className="grid grid-cols-1 items-stretch gap-10 lg:grid-cols-2">
          ...
          <div
            ...
            className="
              animate-fade-in
              rounded-[32px] bg-white/95 px-8 py-8 md:px-10 md:py-10
              shadow-[0_18px_45px_rgba(15,23,42,0.10)]
              border border-slate-100
              flex flex-col justify-between
              transition-all duration-500
              hover:shadow-[0_24px_60px_rgba(15,23,42,0.16)]
              hover:-translate-y-0.5
            "
          >
            {/* Верх: автор + кавычки */}
            <div className="mb-7 flex items-start justify-between gap-4 md:mb-9">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="mt-0.5 text-[11px] md:text-xs text-slate-400">
                    {current.date}
                  </div>
                </div>
              </div>

              <div className="hidden text-4xl font-serif text-slate-200 md:block">
                “
              </div>
            </div>

            {/* Текст отзыва */}
            <p className="mb-6 text-sm md:text-base leading-relaxed text-slate-800">
              {current.text}
            </p>
          ...
          <div
            ...
            className="
              animate-fade-in
              relative h-[260px] md:h-[340px]
              overflow-hidden rounded-[32px]
              shadow-[0_22px_55px_rgba(15,23,42,0.25)]
              bg-slate-900/5
              transition-all duration-500
              hover:-translate-y-0.5 hover:shadow-[0_28px_70px_rgba(15,23,42,0.3)]
            "
          >
            <Image
              src={current.image}
              alt="Интерьер клиента"
              fill
              className="object-cover"
            />
        ...
        <div className="mt-10 flex items-center justify-center gap-5">
          <button
            ...
            className="
              ...
              hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(15,23,42,0.22)]
