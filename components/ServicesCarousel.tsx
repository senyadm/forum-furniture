...
export default function ServicesSection() {
  return (
    <section className="w-full py-6 bg-[#F9FAFB]">
      ...
      {/* 2 карточки */}
      <div className="mx-auto max-w-[1400px] px-6 grid grid-cols-1 md:grid-cols-2 gap-12">
        {cards.map((card, index) => (
          <Link
            key={index}
            href={card.href}
            className="
              group rounded-3xl overflow-hidden bg-white border border-slate-200 
          ...
          >
            ...
            <div className="p-8">
              <h3
                className="
                  text-2xl font-semibold text-slate-900 mb-3
              ...
              <p
                className="
                  text-slate-600 leading-relaxed text-base mb-6
                  transition-all duration-500 ease-out
